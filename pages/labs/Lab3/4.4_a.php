...
function BCC($n, $colorHead="green", $color1="info", $color2="yellow") {
    ...
    ?>
    <table bgcolor="<?php echo $colorHead; ?>" cellpadding="5" cellspacing="0">
        <tr><td colspan="3" style="text-align:center; font-weight:bold; font-size:18px;">Bảng cửu chương <?php echo $n; ?></td></tr>
        <?php
        for ($i = 1; $i <= 10; $i++) {
